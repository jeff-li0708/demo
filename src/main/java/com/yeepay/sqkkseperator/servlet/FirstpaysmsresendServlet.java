...
public class FirstpaysmsresendServlet extends HttpServlet {
	String firstpaysmsresendUri=Config.getInstance().getValue("firstpaysmsresendUri");
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String,String> map	=	new HashMap<String,String>();
		   ...
		   Map<String,String> yopresponsemap	=	YeepayService.yeepayYOP(map,firstpaysmsresendUri);
			

		   request.setAttribute("yopresponsemap",yopresponsemap==null?"系统异常":yopresponsemap);
	       RequestDispatcher view	= request.getRequestDispatcher("/jsp/33firstpaysmsresendResponse.jsp");
