...
public class FirstpayqueryServlet extends HttpServlet {
	String firstpayqueryUri=Config.getInstance().getValue("firstpayqueryUri");
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String,String> map	=	new HashMap<String,String>();
		   ...
		   Map<String,String> yopresponsemap	=	YeepayService.yeepayYOP(map,firstpayqueryUri);
			

		   request.setAttribute("yopresponsemap",yopresponsemap==null?"系统异常":yopresponsemap);
	       RequestDispatcher view	= request.getRequestDispatcher("/jsp/34firstpayqueryResponse.jsp");
